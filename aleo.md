...
the lesson: the chain is a verifier, not an executor. [[soft3]] runs the same shape — [[zheng]] proofs of local work, [[verification-by-recomputation\|verify without re-running]] — computation lives where the hands are
