...
knowledge completeness increases when [[neurons]] create [[cyberlinks]] between [[files]] that represent previously unconnected facts. the [[tri-kernel]] [[focus]] distribution $\phi^*$ reflects collective attention — high-$\phi^*$ regions are well-covered, low-$\phi^*$ regions are sparse.
