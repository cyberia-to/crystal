...
[[karma]] is the canonical score. it accumulates as a [[neuron]]'s [[cyberlinks]] attract [[focus]] across the [[cybergraph]]. high karma signals that a neuron consistently identifies valuable connections between [[files]]. the [[tri-kernel]] uses karma as a trust multiplier in the effective adjacency weight, so karma directly amplifies a neuron's influence on graph computation
